...
from src.apps.porchfestcore.models       import Performance
from src.apps.planyourday.models         import Itinerary
...
#     serializer = PerformanceSerializer(itinerary, many=True)
#     return JsonResponse(serializer.data, safe=False)
#     # try:
#     #     itinerary       = Itinerary.objects.get(id=itinerary_id)
